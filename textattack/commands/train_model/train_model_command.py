...
class TrainModelCommand(TextAttackCommand):
    ...
    A command line parse
    r to train a model from user specifications.
    """

    def __init__(self,train_text, train_labels, eval_text, eval_labels,tokenizer):
    ...
    def run(self, args):
        ...
        train_model(args,self.train_text, self.train_labels, self.eval_text, self.eval_labels,self.tokenizer)
