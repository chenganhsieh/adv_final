...
import textattack
from transformers import BertConfig, BertForSequenceClassification,BertTokenizer,AutoConfig, AutoModelForSequenceClassification
...
def parse_model_from_args(args):
    ...
    tokenizer = BertTokenizer.from_pretrained(args.tokenizer, config=config)
    ...
    model = HuggingFaceModelWrapper(model, tokenizer, batch_size=24)
